...
const Itinerary = ({ trip }) => {    
    const generateDayAccordions = () => {
        ...
        for (let i = 0; i < diffDays; i++) {
            ...
            const dayActivities = trip.days && trip.days[i] ? trip.days[i].activities : [];
                            ...
                            <div className="activities-list">
                                {dayActivities.map((activity, index) => (
                                    <div key={index} className="activity-item">
                                        ...
                                        {activity.time && <p className="activity-time">Open {activity.time}</p>}
        ...
        <div className='itinerary-container'>
            {(trip.startDate == null || trip.endDate == null) ?
                <div className='no-dates-selected'>
                    <div>
                        <p>Looks like you haven&apos;t selected the dates for your trip yet.</p>
                ...
                <div>
                    <div className="hotel-details">
                        ...
                        <div className="hotel-status">
                            <p className="no-hotel-message">Looks like you haven&apos;t booked a hotel yet for this trip.</p>
...
const Budgeting = ({ trip }) => {
  ...
  const [expenses] = useState(trip.budget?.expenses);
            ...
            trip ? (
                ...
                <div className="trips-status">
                    <div className="title-container divider">
                        <h2>Your trip to <span className="title-accent">{trip.location}.</span></h2>
                        <p>Select a different trip</p>
                    </div>
                    <div className="itin-budget-container">
                        <p className={`itin-budget-tab ${currentTab === 'itinerary' && 'active'}`} onClick={() => setCurrentTab('itinerary')}>Itinerary</p>
                        <p className={`itin-budget-tab ${currentTab === 'budgeting' && 'active'}`} onClick={() => setCurrentTab('budgeting')}>Budgeting</p>
                    </div>
                ...
                <div className="trips-status">
                    <h2 className="divider trip-status-pad">Looks like you don&apos;t have any trips scheduled yet.</h2>
                    <p>Get started below.</p>
